...
export default function Home() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="mx-auto flex max-w-6xl xl:max-w-7xl 2xl:max-w-[90rem] flex-col gap-8 px-4 pb-6 pt-4 md:min-h-[calc(100vh-4.5rem)] md:flex-row md:items-center md:px-8 md:pb-10 md:pt-8">
        <div className="flex-1 animate-fade-in-up">
          <div className="flex min-h-[calc(100vh-4.5rem)] flex-col justify-between space-y-5">
