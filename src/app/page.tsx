...
export default function Home() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="mx-auto flex max-w-6xl xl:max-w-7xl 2xl:max-w-[90rem] flex-col gap-10 px-4 pb-8 pt-4 md:min-h-[calc(100vh-4.5rem)] md:flex-row md:items-center md:px-8 md:pb-10 md:pt-8">
        <div className="flex-1 animate-fade-in-up">
          <div className="flex flex-col space-y-6 md:min-h-[calc(100vh-4.5rem)] md:justify-between">
